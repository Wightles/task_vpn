...
class AllServersTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final filteredServers =
        ServerFilter.filterServers(vpnProvider.servers, searchText);
  ...
  Widget _buildSelectedServerSection(
      VpnProvider vpnProvider, List<VpnServer> filteredServers) {
  ...
  Widget _buildServerList(
      Map<String, List<VpnServer>> serversByCountry, VpnProvider vpnProvider) {
    ...
    for (final entry in serversByCountry.entries) {
      ...
      final servers = entry.value
          .where((server) => server.id != vpnProvider.selectedServerId)
          .toList();
